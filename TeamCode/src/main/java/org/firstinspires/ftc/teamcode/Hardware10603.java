...
public class Hardware10603
{
    ...
    public void init(HardwareMap ahwMap) {
        ...
        leftLaunch   = hwMap.dcMotor.get("left_launch_drive");
        rightLaunch  = hwMap.dcMotor.get("right_launch_drive");
        leftPower   = hwMap.dcMotor.get("left_launch_drive");
        rightPower  = hwMap.dcMotor.get("right_launch_drive");
